...
; CHECK-LABEL: srem:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    div.s! @CPI0_0[0], r2, r0, r2
; CHECK-NEXT:    sub @CPI0_0[0], r2, r4
; CHECK-NEXT:    add.eq r2, r0, r4
; CHECK-NEXT:    div.s! @CPI0_0[0], r1, r0, r2
; CHECK-NEXT:    sub @CPI0_0[0], r2, r3
; CHECK-NEXT:    add.eq r2, r0, r3
; CHECK-NEXT:    div r3, r4, r0, r2
; CHECK-NEXT:    and! @CPI0_0[0], r1, r0
